...
export class IpcSetOutputSynchronizationCommand implements ICommand, IpcBlockingCommand {
  ...
  constructor(public readonly synchronize: boolean, public readonly userID?: number, public readonly experimentID?: number, public readonly waitForResponse = false) {}
}
