...
import { PortIsAlreadyOpenException, PortIsUnableToOpenException, PortIsUnableToCloseException, PortIsNotOpenException } from '@diplomka-backend/stim-feature-stimulator/domain';
...
export class RealSerialService extends SerialService {
  ...
  public open(path: string = '/dev/ttyACM0', settings: SerialPort.OpenOptions): Promise<void> {
