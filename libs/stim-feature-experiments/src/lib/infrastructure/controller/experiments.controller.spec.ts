...
//
// import { ExperimentsController } from 'libs/stim-feature-experiments/src/lib/infrastructure/controller/experiments.controller';
...
//       const experiments = new Array(5)
//         .fill(0)
//         .map(() => createEmptyExperiment());
...
//
//       const result: ResponseObject<Experiment> = await controller.experimentById(
//         { id: 1 }
//       );
...
//
//       const result: ResponseObject<Experiment> = await controller.insert(
//         experiment
//       );
...
//
//       const result: ResponseObject<Experiment> = await controller.update(
//         experiment
//       );
//       const expected: ResponseObject<Experiment> = {
//         data: experiment,
