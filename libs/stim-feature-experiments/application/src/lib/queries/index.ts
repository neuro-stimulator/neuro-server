...
export const QueryHandlers = [ExperimentsAllHandler, ExperimentByIdHandler, ExperimentMultimediaHandler, ExperimentNameExistsHandler, ExperimentsFilteredHandler];
