...
//
// import { CommandsService } from '../../../../backup/commands/commands.service';
// import { CommandsModule } from '../../../../backup/commands/commands.module';
...
// import { LowLevelModule } from '../../../../backup/low-level/low-level.module';
// import { SequencesModule } from '../../../../backup/sequences/sequences.module';
// import { IpcModule } from '../../../../backup/ipc/ipc.module';
// import { IpcService } from '../../../../backup/ipc/ipc.service';
// import { createIpcServiceMock } from '../../../../backup/ipc/ipc.service.jest';
// import { SerialService } from '../../../../backup/low-level/serial.service';
// import { FakeSerialService } from '../../../../backup/low-level/fake-serial/fake-serial.service';
// import { TOTAL_OUTPUT_COUNT } from '../../../../backup/config/config';
...
//       experiment = (await experimentsService.insert(
//         experiment
//       )) as ExperimentCVEP;
//
...
//       expect(await commandsService.stimulatorState(true)).toEqual(
...
//
//       expect(await commandsService.stimulatorState(true)).toEqual(
//         expect.objectContaining({ state: 4 })
//       );
//     });
//   });
//
...
//
//       expect(await commandsService.stimulatorState(true)).toEqual(
//         expect.objectContaining({ state: 6 })
//       );
//     });
//   });
//
